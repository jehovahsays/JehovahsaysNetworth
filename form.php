...
ob_end_flush();
?>
<br><a href="./core.html"class="titleInput"><button>core</button></a><br>
<br><a href="./solar.html"class="titleInput"><button>solar</button></a><br>
<br><a href="./light.html"class="titleInput"><button>light</button></a><br>
