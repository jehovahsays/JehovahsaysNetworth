...
<label for="navbar-toggler" class="navbar-toggler">&#9776;<i class="fas fa-bars"></i>        
 ...
 <a href="./blackhole/blackhole/index.html">examples</a>
</div>

    <div class="cli-window">
        <div class="cli-header">
            <span>CLI Emulator - Fallback Mode</span>
        </div>
        <div id="cli-output">
            <p>$ <span id="command"></span></p>
            <p id="response"></p>
        </div>
        <form action="fallback.html" method="get">
            <label for="cli-input">$</label>
            <input type="text" id="cli-input" name="command" list="commands" autocomplete="off"
			id="filterInput"
onkeyup="titleInput()"
autocomplete="true"
autocorrect="off"  
...
<!-- JavaScript Security -->
    ...
    <script>
        ...
        const responses = {
            ...
            "help": "Available commands: ls, pwd, whoami, date",
        };
        document.getElementById("response").innerText = responses[command] || "Command not found.";
    </script>
</body>
</html>
<?PHP
